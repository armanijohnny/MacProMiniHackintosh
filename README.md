...
* **Sleep/Wake**: Have not solved for this yet. Work around solution to shutdown is to turn WIFI off then shutdown. Turned off sleep. This issue is very likley due to USB configuration. I'll try to properly assign the USB ports. 
